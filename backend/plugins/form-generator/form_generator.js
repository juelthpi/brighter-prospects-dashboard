class FormGenerator {
    ...
    extraFields(fieldType) {
        ...
        if (this.fieldType == "file") {
            ...
            var field = `<input type="text" name="options[]" placeholder="Write Option" class="form-control" required>`;
    ...
    addOptions() {
        return `
            <div class="form-group">
                <div class="input-group">
                    <input type="text" name="options[]" placeholder="Write Option" class="form-control" required>
                    <button type="button" class="btn btn-danger input-group-text text-white removeOption"><i class="fas fa-times"></i></button>
                </div>
            </div>
        `;
    }
            ...
            <div class="card-body">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn btn-primary editFormData" data-form_item='${JSON.stringify(
                        formItem
                    )}' data-update_id="${updateId}"><i class="fas fa-edit"></i></button>
    ...
    formEdit(element) {
        ...
        if (formItem.type == "file") {
            html += `
                ...
                <div class="mt-2">
                    <div class="form-group">
                        <select class="select2-multi-select" data-placeholder="Select Extension" name="extensions" multiple>
                            <option value=""></option>
                            <option value="jpg">JPG</option>
                            <option value="jpeg">JPEG</option>
                            <option value="png">PNG</option>
